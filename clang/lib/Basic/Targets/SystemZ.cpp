...
static constexpr int NumBuiltins =
    static_cast<int>(clang::SystemZ::LastSystemZBuiltin) - static_cast<int>(Builtin::FirstTSBuiltin) + 1;
static constexpr int NumBuiltinsZOS =
    static_cast<int>(clang::SystemZ::LastTSBuiltin) - static_cast<int>(clang::SystemZ::LastSystemZBuiltin) - 1;
