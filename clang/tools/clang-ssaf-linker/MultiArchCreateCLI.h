...
public:
  ...
  struct Config {
    Config(llvm::ArrayRef<std::string> InputPaths, llvm::StringRef OutputPath,
           llvm::StringRef Namespace, bool Verbose, bool Time)
        : InputPaths(InputPaths), OutputPath(OutputPath), Namespace(Namespace),
...
private:
  ...
  void validate(llvm::TimerGroup &TG, const Config &Cfg);
