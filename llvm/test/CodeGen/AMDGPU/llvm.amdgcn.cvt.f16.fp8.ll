...
; GFX1250-SDAG-REAL16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1250-GISEL-REAL16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1250-GISEL-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX1250-GISEL-REAL16-NEXT:    s_delay_alu instid0(SALU_CYCLE_3)
...
; GFX1250-SDAG-REAL16-NEXT:    v_nop
; GFX1250-SDAG-REAL16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-REAL16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
...
; GFX1250-GISEL-REAL16-NEXT:    v_nop
; GFX1250-GISEL-REAL16-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-REAL16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
