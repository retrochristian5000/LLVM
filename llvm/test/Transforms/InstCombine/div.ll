...
; CHECK-NEXT:    [[TMP1:%.*]] = mul nuw i32 [[X:%.*]], 5
; CHECK-NEXT:    [[D1:%.*]] = udiv i32 [[TMP1]], 3
...
; CHECK-NEXT:    [[TMP1:%.*]] = mul nuw nsw i32 [[X:%.*]], 5
; CHECK-NEXT:    [[D1:%.*]] = udiv i32 [[TMP1]], 3
; CHECK-NEXT:    ret i32 [[D1]]
;
...
; CHECK-NEXT:    [[TMP1:%.*]] = mul nsw i32 [[X:%.*]], 5
; CHECK-NEXT:    [[D:%.*]] = sdiv exact i32 [[TMP1]], 3
; CHECK-NEXT:    ret i32 [[D]]
;
  %m = mul nsw i32 %x, 150
...
; CHECK-NEXT:    [[TMP1:%.*]] = mul nuw i32 [[X:%.*]], 5
; CHECK-NEXT:    [[D1:%.*]] = udiv exact i32 [[TMP1]], 3
; CHECK-NEXT:    ret i32 [[D1]]
;
  %m = mul nuw i32 %x, 150
...
; CHECK-NEXT:    [[TMP1:%.*]] = mul nsw <2 x i32> [[X:%.*]], splat (i32 5)
; CHECK-NEXT:    [[D:%.*]] = sdiv <2 x i32> [[TMP1]], splat (i32 3)
