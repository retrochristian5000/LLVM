...
; DEFAULT-NEXT:    [[MIN_EPILOG_ITERS_CHECK:%.*]] = icmp ult i64 [[N_MOD_VF]], [[TMP9]]
...
; DEFAULT-NEXT:    [[TMP31:%.*]] = shl nuw i64 [[TMP33]], 3
; DEFAULT-NEXT:    [[N_MOD_VF5:%.*]] = urem i64 [[TMP0]], [[TMP31]]
...
; DEFAULT-NEXT:    [[TMP34:%.*]] = zext <vscale x 8 x i8> [[WIDE_LOAD10]] to <vscale x 8 x i16>
; DEFAULT-NEXT:    [[TMP35:%.*]] = mul <vscale x 8 x i16> [[TMP34]], [[TMP32]]
; DEFAULT-NEXT:    [[TMP39:%.*]] = or <vscale x 8 x i16> [[TMP35]], [[TMP34]]
; DEFAULT-NEXT:    [[TMP37:%.*]] = lshr <vscale x 8 x i16> [[TMP39]], splat (i16 1)
...
; DEFAULT-NEXT:    [[INDEX_NEXT11]] = add nuw i64 [[INDEX9]], [[TMP31]]
