...
; DEFAULT-NEXT:    [[TMP24:%.*]] = zext <vscale x 16 x i8> [[WIDE_LOAD]] to <vscale x 16 x i16>
; DEFAULT-NEXT:    [[TMP25:%.*]] = zext <vscale x 16 x i8> [[WIDE_LOAD4]] to <vscale x 16 x i16>
; DEFAULT-NEXT:    [[TMP16:%.*]] = mul <vscale x 16 x i16> [[TMP24]], [[TMP11]]
; DEFAULT-NEXT:    [[TMP17:%.*]] = mul <vscale x 16 x i16> [[TMP25]], [[TMP11]]
...
; DEFAULT-NEXT:    store <vscale x 16 x i8> [[TMP22]], ptr [[TMP26]], align 1
; DEFAULT-NEXT:    store <vscale x 16 x i8> [[TMP23]], ptr [[TMP29]], align 1
...
; DEFAULT-NEXT:    [[N_MOD_VF5:%.*]] = urem i64 [[TMP0]], 16
; DEFAULT-NEXT:    [[N_VEC6:%.*]] = sub i64 [[TMP0]], [[N_MOD_VF5]]
; DEFAULT-NEXT:    [[BROADCAST_SPLATINSERT7:%.*]] = insertelement <16 x i32> poison, i32 [[X]], i64 0
; DEFAULT-NEXT:    [[BROADCAST_SPLAT8:%.*]] = shufflevector <16 x i32> [[BROADCAST_SPLATINSERT7]], <16 x i32> poison, <16 x i32> zeroinitializer
; DEFAULT-NEXT:    [[TMP28:%.*]] = trunc <16 x i32> [[BROADCAST_SPLAT8]] to <16 x i16>
...
; DEFAULT-NEXT:    [[WIDE_LOAD10:%.*]] = load <16 x i8>, ptr [[TMP36]], align 1
; DEFAULT-NEXT:    [[TMP34:%.*]] = zext <16 x i8> [[WIDE_LOAD10]] to <16 x i16>
