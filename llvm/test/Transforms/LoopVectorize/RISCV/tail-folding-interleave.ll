...
; IF-EVL-NEXT:  entry:
; IF-EVL-NEXT:    [[TMP2:%.*]] = add nsw i32 [[N:%.*]], -1
; IF-EVL-NEXT:    [[TMP3:%.*]] = call i32 @llvm.smin.i32(i32 [[TMP2]], i32 0)
; IF-EVL-NEXT:    [[TMP6:%.*]] = sub i32 [[N]], [[TMP3]]
; IF-EVL-NEXT:    br label [[FOR_BODY:%.*]]
; IF-EVL:       vector.ph:
...
; IF-EVL-NEXT:    [[TMP18:%.*]] = add nuw nsw i64 [[TMP1]], 8
; IF-EVL-NEXT:    [[SCEVGEP1:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP18]]
; IF-EVL-NEXT:    [[TMP19:%.*]] = add nuw nsw i64 [[TMP1]], 12
; IF-EVL-NEXT:    [[SCEVGEP:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP19]]
...
; NO-VP-NEXT:    br i1 [[MIN_ITERS_CHECK]], label [[SCALAR_PH:%.*]], label [[VECTOR_PH:%.*]]
; NO-VP:       vector.ph:
; NO-VP-NEXT:    [[TMP10:%.*]] = shl nuw i32 [[TMP7]], 2
; NO-VP-NEXT:    [[N_MOD_VF:%.*]] = urem i32 [[TMP6]], [[TMP10]]
; NO-VP-NEXT:    [[N_VEC:%.*]] = sub i32 [[TMP6]], [[N_MOD_VF]]
; NO-VP-NEXT:    [[TMP11:%.*]] = sub i32 [[N]], [[N_VEC]]
; NO-VP-NEXT:    [[TMP23:%.*]] = sext i32 [[N]] to i64
; NO-VP-NEXT:    [[TMP9:%.*]] = shl nsw i64 [[TMP23]], 4
; NO-VP-NEXT:    [[SCEVGEP3:%.*]] = getelementptr i8, ptr [[A:%.*]], i64 [[TMP9]]
; NO-VP-NEXT:    [[TMP24:%.*]] = add nuw nsw i64 [[TMP9]], 4
; NO-VP-NEXT:    [[SCEVGEP2:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP24]]
; NO-VP-NEXT:    [[TMP25:%.*]] = add nuw nsw i64 [[TMP9]], 8
; NO-VP-NEXT:    [[SCEVGEP1:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP25]]
; NO-VP-NEXT:    [[TMP26:%.*]] = add nuw nsw i64 [[TMP9]], 12
; NO-VP-NEXT:    [[SCEVGEP:%.*]] = getelementptr i8, ptr [[A]], i64 [[TMP26]]
