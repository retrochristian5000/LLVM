...
public:
  ...
  /// Read memory at the given ProcessAddress (which may name a non-default
  /// address space; see GetAddressSpaces()). Plugins that expose address spaces
  /// handle a non-default space; others should error on one.
